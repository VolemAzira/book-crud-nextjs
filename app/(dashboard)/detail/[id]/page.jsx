      ...
      <main className="mx-auto my-12 flex flex-col gap-3 bg-white p-5 w-full border border-black rounded-lg">
        ...
        <section className="flex justify-between">
          <span className="w-1/2">
            <h2 className="text-lg font-semibold text-gray-800">Detail book</h2>
          ...
          <span className="w-1/2">
            <form className="flex flex-col gap-5">
              ...
              <div className="mt-3">
                <button
                  type="submit"
                  className="rounded-md bg-black px-3 py-2 text-white transition hover:bg-opacity-80 cursor-not-allowed"
                  disabled
                >
                  Edit book
                </button>
